                        ...
                        <div class="one-third column">
                            ...
                            <ul id="services-graph-6" class="services-graph notinview">
                                <li><span title="98"></span>
                                    <p><!-- <strong>98%</strong> --> Technical</p>
                                </li>
                                <li><span title="88"></span>
                                    <p><!-- <strong>88%</strong>  Html &amp; CSS --> Outgoing</p>
                                </li>
                                <li><span title="95"></span>
                                    <p><!-- <strong>95%</strong> Javascript--> Platform for Beginners </p>
                                </li>
                                <li><span title="90"></span>
                                    <p><!-- <strong>90%</strong> Photoshop --> Dynamic </p>
                                </li>
                                <li><span title="60"></span>
                                    <p><!-- <strong>60%</strong> Illustrator --> Professional </p>
                                </li>
                                <li><span title="60"></span>
                                ...
                                <li data-rel='link_magnifier' class="indproj1">
                                    <div class="slides_item post-thumb">
                                        <ul class="ch-grid">
                                            <li>
                                                <div class="ch-item">
                                                    <img class="img_thumb" alt="" src="img/tech2k15/MOMENTUM2.png" />
                                                    <a class="flex_this_thumb" href="img/tech2k15/MOMENTUM2.png"></a>
                                                </div>
                                            </li>
                                        </ul>
                                        <div class="no-flicker">
                ...
                <div class="entry-content">
                    <div class="container">
                        ...
                        <section class='special_tabs'>
                            ...
                            <div class='content 1'>
                                ...
                                <ul>
                                    ...
                                    <li>  <h4><b><u>2. DEBUGGING (solo participation, ENTRY FEE: Rs. 100 per head)</u></b></h4><br>
                                        <h5>1. There will be three levels:<br>
                                    ...
                                    <li> <h4><b><u>3. BACKTRACK (solo participation, ENTRY FEE: Rs. 100 per head)</u></b></h4><br>
                                    <h5>1. Each participant will be provided four different set of rough source codes out of which the participant will have to choose any 2 codes randomly but later on decide upon only one for which he/she will have to write the alternate source code.<br>
                                        2. Conditions for writing the alternate source code-<br>
                                        ...
                                        3. Participants have to bring their laptops (those who do not have will be provided with desktops).<br>
                                    </h5>
                                    </li><br>
                                </ul>
                                <br/>
                            ...
                            <div class='content 3'>
                                ...
                                <ul>
                                    ...
                                    <li> <h4><b><u>3. PAPER GLIDER (groups of 2, ENTRY FEE: Rs. 150 per team)</u></b></h4><br>
                                    <!--      <h5>1. Each participant will be provided four different set of rough source codes out of which the participant will have to choose any 2 codes randomly but later on decide upon only one for which he/she will have to write the alternate source code.<br>
                                            2. Conditions for writing the alternate source code-<br>
                                            a)	Duration is of 20 to 30 minutes.<br>
                                            b)	The alternate source must be different from the given source code.<br>
                                    ...
                                    <li> <h4><b><u>4. BRIDGE BUILDING (groups of 2, ENTRY FEE: Rs 500 per team)</u></b></h4><br>
                                   <!--     <h5>1. Each participant will be provided four different set of rough source codes out of which the participant will have to choose any 2 codes randomly but later on decide upon only one for which he/she will have to write the alternate source code.<br>
                                            2. Conditions for writing the alternate source code-<br>
                                            a)	Duration is of 20 to 30 minutes.<br>
                                            b)	The alternate source must be different from the given source code.<br>
                            ...
                            <div class='content 4'>
                                ...
                                <ul>
                                    <li> <h4><b><u> LANTHRASH (groups of 5, ENTRY FEE: Rs. 500 per team)</u></b></h4><br>
                                        <!--   <h5>1. There will be three levels:<br>
                                               a) LEVEL 1 : Given 15 questions and the time for completion will be 15 mins.<br>
                                               b) LEVEL 2 : Given 10 questions and the time for completion will be 10 mins.<br>
                                               c) LEVEL 3 : Given 7 questions and the time for completion will be 7 mins.<br>
                            ...
                            <div class='content 5'>
                                ...
                                <div>
                                    <ul>
                                        ...
                                        <h5>1.	Only one participant is allowed.<br>
                                            ...
                                            7.	Each participant has only two chances. Before choosing 2nd, one has to assure that they cannot switch back again.<br></h5>
                                        </li><br>

                                        <li><h4><b><u>	2. MOCK TEST (solo participation, ENTRY FEE: Rs.100 per head)</u></b></h4><br>
                                        <h5> 1.	The whole event will consist of three rounds-<br>
                                            ...
                                            <b>Personal interview</b>-<br>
                                                Evaluation will be purely done by the judges based on certain criteria.<br></h5>
                                        </li><br>
                                        ...
                                        <li><h4><b><u> 5. RJ HUNT (solo participation, ENTRY FEE: Rs.50 per head) </u></b></h4><br>
                                        <!--    <h5>1.	Only one participant is allowed.<br>
                                                2.	Participants will be given 3 minutes for preparation.<br>
                                                3.	Time for the final speech will be 5 minutes.<br>
                                                4.	The language should be strictly English.<br>
                            ...
                            <div class='label 6'>
                                ...
                                </div><span class='tab_title'>General Management Events</span>
                            </div>
                             <div class='content 6'>
                                     <h1 class="aligncenter">General Management Events</h1>
                                 <ul>
                                     ...
                                     <li><h4><b><u> 2. PROJECT PRESENTATION (solo participation, ENTRY FEE: Rs.100 per head) </u></b></h4><br>
                                     <!--    <h5>1.	Only one participant is allowed.<br>
                                             2.	Participants will be given 3 minutes for preparation.<br>
                                             3.	Time for the final speech will be 5 minutes.<br>
                                             4.	The language should be strictly English.<br>
                                     ...
                                     <li><h4><b><u> 3. QUIZ (groups of 4, ENTRY FEE: Rs.200 per team) </u></b></h4><br>
                                     <!--    <h5>1.	Only one participant is allowed.<br>
                                             2.	Participants will be given 3 minutes for preparation.<br>
                                             3.	Time for the final speech will be 5 minutes.<br>
                                             4.	The language should be strictly English.<br>
                                     ...
                                     <li><h4><b><u> 4. IQ SECTOR (solo participation, ENTRY FEE: Rs.50 per head) </u></b></h4><br>
                                     <!--    <h5>1.	Only one participant is allowed.<br>
                                             2.	Participants will be given 3 minutes for preparation.<br>
                                             3.	Time for the final speech will be 5 minutes.<br>
                                             4.	The language should be strictly English.<br>
                            ...
                            <div class='label 7'>
                                ...
                                <span class='tab_title'>Other Events</span>
                            </div>
                            <div class='content 7'>
                                <h1 style="text-align: center;">Other Events</h1>
                                <br/>
                                <ul>
                                    <li><h4><b><u> 1. T-SHIRT DESIGNING (solo participation, ENTRY FEE: Rs.200 per head) </u></b></h4><br>
                                    <!--    <h5>1.	Only one participant is allowed.<br>
                                        2.	Participants will be given 3 minutes for preparation.<br>
                                        3.	Time for the final speech will be 5 minutes.<br>
                                        4.	The language should be strictly English.<br>
                                    ...
                                    <li><h4><b><u> 2. PHOTOMANIA (solo participation, ENTRY FEE: Rs.150 per head) </u></b></h4><br>
                                    <!--    <h5>1.	Only one participant is allowed.<br>
                                        2.	Participants will be given 3 minutes for preparation.<br>
                                        3.	Time for the final speech will be 5 minutes.<br>
                                        4.	The language should be strictly English.<br>
                        ...
                        <div class="shortcode-accs acc-substitute default">
                            ...
                            <!-- BEGIN: SECTION #03 -->
                            <div class="acc-title">
                                <h2 style="cursor:pointer;"><i class="fa fa-gift"></i>Mechanical/Civil Events</h2>
                            </div>
                            <div class="pane acc-sec">
                                <h1 class="aligncenter">Mechanical/Civil Events</h1>
                                <ul>
                            ...
                            <!-- BEGIN: SECTION #04 -->
                            <div class="acc-title">
                                <h2 style="cursor:pointer;"><i class="fa fa-beaker"></i>Gaming Events</h2>
                            </div>
                            <div class="pane acc-sec">
                            ...
                            <!-- BEGIN: SECTION #05 -->
                            <div class="acc-title">
                                <h2 style="cursor:pointer;"><i class="fa fa-html5"></i>Vocational Skill Events</h2>
                            </div>
                            <div class="pane acc-sec">
                            ...
                            <!-- BEGIN: SECTION #06 -->
                            <div class="acc-title">
                                <h2 style="cursor:pointer;" class=" "><i class="fa fa-adn"></i>General Management Events</h2>
                            </div>
                            <div class="pane acc-sec">
                                <h1 class="aligncenter">General Management Events</h1>
                                <ul>
                            ...
                            <div class="acc-title">
                                <h2 style="cursor:pointer;" class=" "><i class="fa fa-columns"></i>Other Events</h2>
                            </div>
                            <div class="pane acc-sec">
                                <h1 style="text-align: center;">Other Events</h1>
                                <ul>
